...
with st.container():
    ...
    st.write("Le modèle de réseau de neurones est basé sur un mobilenet à été entraîné avec un dataset de  300 photos de chiens (100 photos de chihuahua 100 photos de labrador et 100 photos de husky). Le nombre d'epoque est de 20, le nombre de batch est de 16 et le learning rate est de 0.0001. ")
    st.write("")
